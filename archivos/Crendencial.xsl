...
<xsl:stylesheet version='1.0' xmlns:xsl='http://www.w3.org/1999/XSL/Transform'>
	<xsl:template match='/'>  
		<html> 
			...
			<body>  
				<xsl:for-each select='Escuelas/Escuela'>
					<div id='credencial'>
						<div id='encabezado'>  
						...
						<div id='foto'> 
								<xsl:element name='img'> 
									<xsl:attribute name='src'> 
										<xsl:value-of select='Carrera/Alumno/@fotoDeAlumno'/>
						...
						<div id='datos'>
							<h4>
								<xsl:value-of select='Carrera/Alumno/@nombreDeAlumno'>
								</xsl:value-of>
							</h4>
							<h4>
								<xsl:value-of select='Carrera/Alumno/@boletaDeAlumno'>
								</xsl:value-of>
							</h4>
						</div>
					</div>  
					...
					<div id='credencial'>  
						...
						<div id='logoInstituto' class=''>
							<img src='imagen base 64' alt='' width='74' height='101'/>
						<div id='datos'>    
							<p><xsl:value-of select='Carrera/@nombreDeCarrera'></xsl:value-of></p>
						</div>
					</div> 
					</div>
				</xsl:for-each>  
